...
const PaymentConfirmation = () => {
  ...
  const full_access =
    subscriptionType === null || subscriptionType === "full_access";
  const news = subscriptionType === "news";
          ...
          >
            ...
            {isFreeTrial ? (
              <StyledTypography2 marginTop={1} color={colors.navyBlue200}>
                This is official confirmation.You got <b>Trial Access</b> for
                free.
              </StyledTypography2>
            ) : news ? (
              <StyledTypography2 marginTop={1} color={colors.navyBlue200}>
                This is official confirmation.Thanks for joining Sovrenn Times
                Access.
              </StyledTypography2>
            ) : full_access ? (
              <StyledTypography2 marginTop={1} color={colors.navyBlue200}>
            ...
            {!isFreeTrial ? (
              <StyledTypography2 color={colors.navyBlue200}>
                You will be added to Sovrenn Times group shortly in the next
                24-48 hours. In case you are not added, please send an email at{" "}
                <Typography
                  component="a"
