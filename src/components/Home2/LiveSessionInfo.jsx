...
const LiveSessionInfo=()=>{
  ...
  Session
    ...
    Elevate Your Investing Journey with Expert Knowledge and Practical Insights
  </StyledTypography2>
    ...
    <List sx={{ width: '100%', listStyleType: 'disc',padding:0 ,height:"46vh"}}>
            <StyledTypography3 variant="h6" component="h2" gutterBottom color="#101828">
           {element.h1}
            </StyledTypography3>
            {
        ...
        <Grid container alignItems="center" direction="column" spacing={3}>
            <Grid item>
            <Typography   color="#667085" marginRight={0.5} component="span" sx={{fontWeight:"600",fontSize:"14px",lineHeight:"17px"}} >
        Upcoming Session:
       </Typography>
       <Typography   color="#101828" component="span" sx={{fontWeight:"600",fontSize:"14px",lineHeight:"17px"}} >
