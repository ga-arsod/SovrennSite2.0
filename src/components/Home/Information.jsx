...
<>
<Box>
  <Grid container direction="column" justifyContent="center" alignItems="center" spacing={1} paddingX={2} paddingY={4}>
    <Grid item>
      <Typography sx={{textAlign:'center'}} gutterBottom>
      <StyledTypography1 component="span"  marginRight={1} color="#0D1726">
  Everything You Need to Know About 
  </StyledTypography1>
  <StyledTypography1 component="span"  color={theme.palette.primary.main}>
  Sovrenn
  </StyledTypography1>
      </Typography>
