...
const navItems=["Education","Times","Prime","Discovery","IPO","Knowledge","Self Help","Pricing"];
...
const Navbar = () => {
  ...
  <>
   ...
   <AppBar sx={{ backgroundColor: '#F4F6F8',boxShadow:"none",position:"relative",zIndex:10}}>
       ...
       <List sx={{ display: 'flex', flexDirection: 'row', padding: 0 }}>
        {
          navItems.map((item)=>{
            return(
              <ListItem onClick={()=>{setOpen(false)}} key={item} sx={{px:1,whiteSpace: 'nowrap',
        ...
        <SearchInput
          ...
          <StyledGrid1 item sx={{display:{xs:"none",sm:"flex"},alignItems:"center"}}>
            <Box sx={{backgroundColor:"#172641",borderRadius:"50%",padding:"2px",width:"30px",height:"30px",display:"flex",justifyContent:"center",alignItems:"center"}}>
      ...
      <SearchIcon/> 
       ...
       <StyledButton2 variant="contained" disableElevation>Login</StyledButton2>
       </StyledGrid3>
     <StyledGrid4 item >
     <IconButton>
      <SearchIcon/>
  ...
  ModalProps={{ hideBackdrop: true }} 
     ...
     >
      <Box p={3} role="presentation" textAlign="center" sx={{ display: 'flex', flexDirection: 'column',justifyContent:"center", alignItems:"center", padding: 0 }}>
      <List  >
        {
          navItems.map((item)=>{
            return(
              <ListItem key={item} sx={{px:1,whiteSpace: 'nowrap',
