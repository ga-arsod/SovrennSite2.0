...
const TestPerformance = () => {
  const { examResult } = useSelector((store) => store.investing);
  const [open, setOpen] = useState(false);
  const handleClose = () => {
    setOpen(false);
  };
  const imageUrl=examResult?.is_passed ? "/test-performance-image2.png" :"/test-performance-image1.png"
            ...
            >
              ...
              >
                ...
                <CardContent>
                  ...
                  <StyledTypography3 color="#6A7891">
                    <span
                      style={{
                        color: examResult?.is_passed ? "#43CB43" : "#F60909",
                      }}
                    >
                      {" "}
                      {examResult?.score}
