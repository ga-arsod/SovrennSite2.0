...
const ApplyButton = () => {
  ...
  return (
    <>
      ...
      {
        mentorshipInfo?.button_details?.allow_payment ?  <StyledButton1 mb={5} disabled={!mentorshipInfo?.button_details?.allow_payment} onClick={handleButtonClick}>{mentorshipInfo?.button_details?.text}</StyledButton1>
        : <></>
      }
