...
const CheckQuestionsAttemptModal = ({checkQuestionsAttempt,setCheckQuestionsAttempt,handleSubmit}) => {
    const dispatch=useDispatch()
 const handleClose=()=>{
    setCheckQuestionsAttempt(false)
 }

  return (
    <Modal
      open={checkQuestionsAttempt}
      onClose={handleClose}
        ...
        >
          ...
          >
            <Grid item paddingX={{ xs: 2, sm: 4 }} width="100%">
              ...
              You have some unattempted questions.
              </StyledTypography2>
              <StyledTypography2 color={colors.navyBlue500}  marginTop={2}>
              Submit anyway?
              </StyledTypography2>
...
export default CheckQuestionsAttemptModal;
