...
import FinalAccountDelete from "../Modal/FinalAccountDelete";
...
const DeleteAccountModal = ({ open, setOpen}) => {
 const [isOpen,setIsOpen]=useState(false)
  ...
  return (
    <>
   <FinalAccountDelete isOpen={isOpen} setIsOpen={setIsOpen}/>
    <Modal
      open={open}
      onClose={handleClose}
        ...
        >
          ...
          >
            <Grid item paddingX={{ xs: 2, sm: 4 }}>
              ...
              Deleting your account will cause you to lose all the access.
              </StyledTypography1>
            </Grid>
            <Grid item width="100%">
              <Grid
