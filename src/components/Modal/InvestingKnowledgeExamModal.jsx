...
const InvestingKnowledgeExamModal = ({submitExamModal,setSubmitExamModal}) => {
      ...
      <StyledBox>
        ...
        >
          ...
          <Grid
            ...
            gap={4}
          >
            <Grid item paddingX={{ xs: 2, sm: 4 }} width="100%">
              <StyledTypography1 color={colors.navyBlue500} textAlign="center" marginTop={1}>
              Do you really want to quit?
              </StyledTypography1>
             
              <StyledTypography2 color={colors.navyBlue500}  marginTop={2} textAlign="center">
              If you quit now, you will lose your current progress.
              </StyledTypography2>
            </Grid>
            <Grid item width="100%">
              <Grid
...
export default InvestingKnowledgeExamModal;
